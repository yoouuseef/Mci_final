      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 offset-md-1">
          <div class="heading_container">
            <h2 >
                UNAVAILABLE <span class="MN">PROJECTS</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-md-5 offset-md-1">
          <div class="form_container">
            <table border="1" cellpadding="15" cellspacing="0"class="BN">
                ...
                <tbody>
                <?php
                  $sql = "SELECT projectname, prcodetype, id FROM t_projectsstu";
                  ...
                  if(mysqli_num_rows($sql_run) > 0)
                  {
                    foreach($sql_run as $items)
                    {
                      ...
                      ?>
                      <tr>
                        <th><?php echo $items['prcodetype']; ?></th>
                        <th><?php echo $items['projectname']; ?></th>
